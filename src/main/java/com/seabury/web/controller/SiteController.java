...
public class SiteController {
    ...
    public @ResponseBody List<Map<String, Object>> getSiteList(HttpServletRequest request, HttpServletResponse response, @RequestBody(required = false) Map<String, Object> message) {
